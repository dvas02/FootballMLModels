...
# Model Training
# Using XGBoost as a second try
model = xgb.XGBClassifier(n_estimators=150, random_state=42, eval_metric='logloss')
...
grid_search = GridSearchCV(estimator=xgb.XGBClassifier(random_state=42, eval_metric='logloss'),
                           ...
                           scoring='precision',  # or 'f1' if you want to consider both precision and recall
                           cv=5,
                           verbose=1)
